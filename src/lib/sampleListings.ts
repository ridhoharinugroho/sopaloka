...
export const SAMPLE_LISTINGS: ListingItem[] = [
  ...
  },
  {
    ...
    regionId: "3372",
    district: "Banjarsari",
    districtCode: "3372040",
    codPoint: "COD Manahan / Solo Paragon",
    description:
      "Laptop Asus Vivobook warna silver mulus terawat. Intel Core i5 Gen 11, RAM 8GB, SSD 512GB kencang. Baterai awet 4 jam. Lengkap unit, charger original, tas laptop.",
