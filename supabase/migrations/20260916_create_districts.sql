-- Migration: Create districts table and add district column to listings

CREATE TABLE IF NOT EXISTS districts (
  id VARCHAR PRIMARY KEY,
  regency_code VARCHAR NOT NULL,
  name VARCHAR NOT NULL
);

ALTER TABLE listings ADD COLUMN IF NOT EXISTS district_code VARCHAR;
ALTER TABLE listings ADD COLUMN IF NOT EXISTS district VARCHAR;

INSERT INTO districts (id, regency_code, name) VALUES
